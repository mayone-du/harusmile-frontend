...
export const BottomNavigation: React.VFC = () => {
  return (
    <div>
      {/* スマホ時 */}
      <nav className="md:hidden fixed border p-2 bottom-0 w-full z-50 bg-white">
        <ul className="flex items-center justify-around">
          ...
          <li className="w-1/5 relative">
            <Link href="/">
              <a className="flex flex-col items-center justify-center bg-blue-600 rounded-full w-16 h-16 absolute -top-12 left-1/2 transform -translate-x-1/2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
